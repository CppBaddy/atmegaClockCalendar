...
const uint8_t f6x8_table[f6x8_NOFCHARS][f6x8_MONO_HEIGHT + 2] PROGMEM = {
// 0x00
  {
   f6x8_MONO_WIDTH,
   f6x8_MONO_HEIGHT,
...
{
  for (uint8_t i = 0; i < f6x8_MONO_HEIGHT + 2; ++i)
  {
    f6x8_charbuff[i] = pgm_read_byte(&f6x8_table[Char][i]);
  }
